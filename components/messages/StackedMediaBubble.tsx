...
export default function StackedMediaBubble({
  ...
  const STACK_OFFSET = 6; // px each card peeks behind
  ...
  // Stack: show top 3 cards fanned behind each other
  const visibleCount = Math.min(total, 3);
  // Cards render back-to-front so the first attachment is on top
        ...
        {stackCards.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              {/* Badge on top card showing total count */}
