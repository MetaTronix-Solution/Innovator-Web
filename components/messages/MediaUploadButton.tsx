...
//       </a>
//       <div
//         className="max-w-[90vw] max-h-[85vh] relative w-full"
//         style={{ height: "85vh" }}
//       >
//         <Image
//           src={src}
...
//   const resolvedSrc = getMediaUrl(attachment) || attachment;
...
//           }`}
//           style={{ maxWidth: 220, minWidth: 120, height: 180 }}
...
//         </div>
//         {lightbox === "video" && (
//           <VideoLightbox src={resolvedSrc} onClose={() => setLightbox(null)} />
//         )}
//       </>
//     );
//   }
...
//         // objectUrl is a blob: URL — Next Image doesn't support blob URLs, use a regular img here
